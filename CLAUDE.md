...
Currently supports C, C++, C#, F#, Go, Java, JavaScript, Kotlin, Objective-C, PHP, Python, Ruby, Rust, and TypeScript via Tree-sitter grammars. Language detected by file extension.
